{: 3D Sound sample (BASS manager is used in this sample).
   ...
   referred and used by the TGLSMBASS sound manager.
...
begin
  ...
  Application.CreateForm(TFormSoundBASS, FormSoundBASS);
  Application.Run;
end.

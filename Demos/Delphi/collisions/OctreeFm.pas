...
var
  FormOctree: TFormOctree;

implementation

{$R *.dfm}

procedure TFormOctree.FormCreate(Sender: TObject);
var
   t : Int64;
begin
...
procedure TFormOctree.GLSceneViewer2MouseMove(Sender: TObject;
...
procedure TFormOctree.GLCadencer1Progress(Sender: TObject; const deltaTime,
  newTime: Double);
begin
...
procedure TFormOctree.Timer1Timer(Sender: TObject);
begin
   // Show FPS Rating

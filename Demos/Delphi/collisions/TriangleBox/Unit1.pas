...
procedure TForm1.DrawCoplanarPolygon;
begin
...
procedure TForm1.RadioGroupCoPolygonClick(Sender: TObject);
begin
...
procedure TForm1.ButtonFindIntersectClick(Sender: TObject);
var
  IterCnt : Integer;
  Res1    : Boolean;
begin
...
procedure TForm1.ButtonNotFindIntersectClick(Sender: TObject);
var
  IterCnt : Integer;
  Res1    : Boolean;
begin
...
procedure TForm1.CheckBoxVisibleClick(Sender: TObject);
begin

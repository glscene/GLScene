...
uses
  ...
  GLS.Scene, GLS.Objects, GLS.Coordinates, GLS.Cadencer,  GLS.VectorTypes,
  GLS.SceneViewer, GLS.Color,  GLPhysX, GLS.Keyboard,
  GLS.BaseClasses, GLS.VectorGeometry, GLS.GeomObjects, GLS.Gui, GLS.Windows;

...
procedure TFormFastFT.But1DFFTClick(Sender: TObject);
var
...
procedure TFormFastFT.Load1DBmp(out buf: TByteDynArray);
var
  h, i, j, w: integer;
  bmp: TBitmap;
begin
...
procedure TFormFastFT.Save1DBmp(buf: TByteDynArray);
var
  bmp: TBitmap;
begin
...
procedure TFormFastFT.DrawBmp(bmp: TBitmap; buf: TByteDynArray);
var
  h, i: integer;
begin
  h := bmp.Height;
...
procedure TFormFastFT.But2DFFTClick(Sender: TObject);
var
...
procedure TFormFastFT.Load2DBmp(out buf: TByte2DArray);
var
  bmp: TBitmap;
  i, j, k, w, h: integer;
begin
...
procedure TFormFastFT.LoadLenna(out buf: TByte2DArray);
var
  pgm: TGLPGMImage;
  img: TGLImage;
  i, j, w, h: integer;
...
procedure TFormFastFT.Save2DBmp(buf: TByte2DArray);
var
  i, h: integer;
  bmp: TBitmap;
begin
...
function TFormFastFT.GetDisplayMode: TProcessMode;
begin
...
procedure TFormFastFT.FormCreate(Sender: TObject);
var
  bmp: TBitmap;
  pPal: PLogPalette;
begin
...
procedure TFormFastFT.FormDestroy(Sender: TObject);
begin
...
//
procedure TFormFastFT.ExecDemo(Sender: TObject);
begin
  case DemoMode of
    dm1D:

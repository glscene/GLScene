...
procedure TFormFacevsFace.CollisionManager1Collision(Sender: TObject; object1,
  object2: TGLBaseSceneObject);
begin
...
procedure TFormFacevsFace.GLSceneViewer1MouseDown(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
...
procedure TFormFacevsFace.GLSceneViewer1MouseMove(Sender: TObject;
...
procedure TFormFacevsFace.FormMouseWheel(Sender: TObject; Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
var
   Camera: TGLCamera;
begin

...
__fastcall TFormTorqueC::TFormTorqueC(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void __fastcall TFormTorqueC::GLSceneViewer1MouseMove(TObject *Sender, TShiftState Shift,
		  int X, int Y)
{
...
//---------------------------------------------------------------------------
void __fastcall TFormTorqueC::GLCadencer1Progress(TObject *Sender, const double deltaTime,

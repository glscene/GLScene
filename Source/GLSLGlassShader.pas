...
Type
  ...
  public
    ...
    property BlendSrc  : TGLBlendFunction read FBlendSrc write FBlendSrc default bfSrcAlpha;
    property BlendDst  : TGLBlendFunction read FBlendDst write FBlendDst default bfDstAlpha;
  end;

  ...
  try
    ...
    begin
      ...
      begin
        ...
        frame.Position.Add(GLS.Utils.StrToFloatDef(tl[1]),
          GLS.Utils.StrToFloatDef(tl[2]), GLS.Utils.StrToFloatDef(tl[3]));
        v := AffineVectorMake(GLS.Utils.StrToFloatDef(tl[4]),
          GLS.Utils.StrToFloatDef(tl[5]), GLS.Utils.StrToFloatDef(tl[6]));
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                boneIDs[j].Weight := GLS.Utils.StrToFloatDef(tl[11 + j * 2]);
              end;

              nVert := FindOrAdd(boneIDs,
                AffineVectorMake(GLS.Utils.StrToFloatDef(tl[1]),
                GLS.Utils.StrToFloatDef(tl[2]), GLS.Utils.StrToFloatDef(tl[3])),
                AffineVectorMake(GLS.Utils.StrToFloatDef(tl[4]),
                GLS.Utils.StrToFloatDef(tl[5]),
                GLS.Utils.StrToFloatDef(tl[6])));
              nTex := TexCoords.FindOrAdd
                (AffineVectorMake(GLS.Utils.StrToFloatDef(tl[7]),
                GLS.Utils.StrToFloatDef(tl[8]), 0));

...
public:
	static void __fastcall IntroSort(const void * pItems, const NativeInt pLeft, const NativeInt pRight, const TPasGLTFTypedSortCompareFunction pCompareFunc);
public:
...
public:
	...
	__property NativeInt Count = {read=fCount, write=SetCount};
	__property NativeInt Allocated = {read=fAllocated};
...
private:
	...
	int fLogSize;
	int fSize;
	TPasGLTFHashMapEntities fEntities;
...
public:
	...
	__published:
		...
		__property NativeInt Scene = {read=fScene, write=fScene};
	...
	__published:
		__property NativeUInt ByteLength = {read=fByteLength, write=fByteLength};
		__property System::UTF8String Name = {read=fName, write=fName};
	...
	__published:
		__property System::UTF8String Name = {read=fName, write=fName};
		__property NativeInt Buffer = {read=fBuffer, write=fBuffer};
		__property NativeUInt ByteOffset = {read=fByteOffset, write=fByteOffset};
		__property NativeUInt ByteLength = {read=fByteLength, write=fByteLength};
		__property NativeUInt ByteStride = {read=fByteStride, write=fByteStride};
	...
	__published:
		__property NativeInt BufferView = {read=fBufferView, write=fBufferView};
		__property System::UTF8String Name = {read=fName, write=fName};
		__property System::UTF8String URI = {read=fURI, write=fURI};
	...
	public:
		...
		__published:
			__property NativeInt Index = {read=fIndex, write=fIndex};
			__property NativeInt TexCoord = {read=fTexCoord, write=fTexCoord};
			__property bool Empty = {read=GetEmpty, nodefault};
		};
	...
	public:
		...
		__published:
			...
			__property NativeInt Indices = {read=fIndices, write=fIndices};
			__property NativeInt Material = {read=fMaterial, write=fMaterial};
	...
	__published:
		__property System::UTF8String Name = {read=fName, write=fName};
		__property NativeInt Camera = {read=fCamera, write=fCamera};
		__property NativeInt Mesh = {read=fMesh, write=fMesh};
		__property NativeInt Skin = {read=fSkin, write=fSkin};
	...
	__published:
		__property System::UTF8String Name = {read=fName, write=fName};
		__property NativeInt InverseBindMatrices = {read=fInverseBindMatrices, write=fInverseBindMatrices};
		__property NativeInt Skeleton = {read=fSkeleton, write=fSkeleton};
	...
	__published:
		__property System::UTF8String Name = {read=fName, write=fName};
		__property NativeInt Sampler = {read=fSampler, write=fSampler};
		__property NativeInt Source = {read=fSource, write=fSource};
	};

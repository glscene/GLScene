...
_DECLARE_METACLASS(System::TMetaClass, TGLMeshObjectListClass);
...
typedef System::StaticArray<PGLVertexBoneWeightArray, 134217728> TGLVerticesBoneWeights;
...
_DECLARE_METACLASS(System::TMetaClass, TGLVectorFileClass);

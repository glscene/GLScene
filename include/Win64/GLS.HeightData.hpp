...
typedef System::StaticArray<Gls::Vectorgeometry::PByteVector, 134217728> TByteRaster;
...
typedef System::StaticArray<Gls::Vectorgeometry::PFloatVector, 134217728> TSingleRaster;

typedef TSingleRaster *PSingleRaster;

_DECLARE_METACLASS(System::TMetaClass, TGLHeightDataClass);

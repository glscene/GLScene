...
__published:
	__property NativeInt Position = {read=fPosition, write=fPosition};
public:
...
public:
	...
	virtual void __fastcall Merge(TPasJSONItem* const aWith, const TPasJSONMergeFlags aFlags = TPasJSONMergeFlags() );
	__property NativeInt Count = {read=fCount};
...
public:
	...
	static __int64 __fastcall GetInt64(TPasJSONItem* const aItem, const __int64 aDefault = (__int64)(0LL));

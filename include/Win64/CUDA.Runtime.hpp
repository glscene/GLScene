...
extern DELPHI_PACKAGE TcudaError __stdcall (*cudaMemcpyToSymbol)(char * symbol, void *src, NativeUInt count, const NativeUInt offset/* = (NativeUInt)(0ULL)*/, const TcudaMemcpyKind kind/* = (TcudaMemcpyKind)(0x1)*/);
extern DELPHI_PACKAGE TcudaError __stdcall (*cudaMemcpyFromSymbol)(void *dst, char * symbol, NativeUInt count, const NativeUInt offset/* = (NativeUInt)(0ULL)*/, const TcudaMemcpyKind kind/* = (TcudaMemcpyKind)(0x2)*/);

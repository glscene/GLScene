...
// (DO NOT EDIT: machine generated header) 'OpenGL.InitVCL.pas' rev: 35.00 (Windows)

#ifndef Opengl_InitvclHPP
#define Opengl_InitvclHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_OPENGL_INITVCL)
using namespace Opengl::Initvcl;
#endif
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_OPENGL)
